...
export const pathways: DestinationContent[] = [
  ...
  build({
    ...
    h1: 'Switch from a UK Student Visa to a Skilled Worker Visa',
    title: 'Switch UK Student Visa to Skilled Worker Visa',
    description: 'How international students in the UK can lawfully switch to a Skilled Worker visa: licensed sponsor, eligible job, salary, English and timing rules.',
  ...
  build({
    ...
    h1: 'UK Graduate Visa to Skilled Worker Visa: Your Options',
    title: 'UK Graduate Visa to Skilled Worker Visa Guide',
    description: 'Switching from the UK Graduate visa to a Skilled Worker visa: how it works, when to start job hunting, sponsor checks and what to prepare.',
  ...
  build({
    ...
    h1: 'Canada PGWP to PR: Lawful Pathways After Graduation',
    title: 'Canada PGWP to PR: Pathways for Graduates',
  ...
  build({
    ...
    h1: 'Australia 485 Visa to Employer-Sponsored Visa',
    title: 'Australia 485 to Employer-Sponsored Visa',
  ...
  build({
    ...
    h1: 'New Zealand Accredited Employer Work Visa (AEWV) Guide',
    title: 'New Zealand Accredited Employer Work Visa Guide',

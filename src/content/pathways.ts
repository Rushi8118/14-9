...
export const pathways: DestinationContent[] = [
  ...
  build({
    ...
    h1: 'UK Student Visa to Work Visa: Switching to a Skilled Worker Visa',
    title: 'UK Student Visa to Work Visa: Skilled Worker Switch',
  ...
  build({
    ...
    h1: 'UK Post-Study Work Visa: Graduate Route to Skilled Worker Visa',
    title: 'UK Post-Study Work Visa: Graduate to Skilled Worker',
  ...
  build({
    ...
    h1: 'Canada Post-Study Work Visa (PGWP) to PR: Lawful Pathways',
  ...
  build({
    ...
    h1: 'Australia Post-Study Work Visa (485) to Employer-Sponsored Visa',
  ...
  build({
    ...
    h1: 'New Zealand Work Visa After Study: Accredited Employer Work Visa (AEWV)',
    title: 'NZ Work Visa After Study: AEWV Guide',

    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-border p-3">
        ...
        <div className="flex gap-2">
          ...
          />
          <Button type="button" size="sm" variant="outline" onClick={loadTrends} disabled={loadingTrends}>
            ...
            <div className="mt-2 flex max-h-48 flex-wrap gap-1.5 overflow-y-auto">
              {trends.map((k) => (
                <button
                  ...
                  className={cn('rounded-full border px-2 py-0.5 text-[11px] transition-colors hover:border-primary hover:text-primary',
